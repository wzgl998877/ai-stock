...
class ChatUseCase:
    ...
    def __init__(self, chat_repo: ChatRepository, ai_service: AIService, analysis_graph=None, stock_analysis_graph=None, article_repo=None, stock_analysis_repo=None):
